...
//       ,AD_Correct_Vref.Flag.bit.ADRef_Correct_Ok*10,UART1_Info.RXD_W[0],System_ProtectFlag_Info.all);//
    ...
    Function_TxSendDebug_Five_INT(COM_AD_Data_Info.VACIN_RMS_Val_Fir / 10, COM_Ctr_Info.INV_PFC_Mode_Select, COM_AD_Data_Info.VACOUT_ActivePower, COM_AD_Data_Info.VACIN_PFC_Power,System_ProtectFlag_Info.all);
}
